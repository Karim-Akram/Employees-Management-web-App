...
export class Employee extends Component{
    ...
    changeEmloyeePhone =(e)=>{
        this.setState({EmloyeePhone:e.target.value});
    }
    changeEmployeeAge =(e)=>{
    ...
    createClick(){
        fetch(variables.API_URL+'employee',{
            ...
            body:JSON.stringify({
                ...
                EmloyeePhone:this.state.EmloyeePhone,
   ...
   <div className="modal-body">
    <div className="d-flex flex-row bd-highlight mb-3">
     ...
     <div className="p-2 w-50 bd-highlight">
        ...
        <div className="input-group mb-3">
            <span className="input-group-text">Emloyee Phone</span>
            <input type="text" className="form-control"
            value={EmloyeePhone}
            onChange={this.changeEmloyeePhone}/>
        </div>
        <div className="input-group mb-3">
            <span className="input-group-text">Employee Age</span>
            <input type="text" className="form-control"
            value={EmployeeAge}
            onChange={this.changeEmployeeAge}/>
        </div>
        <div className="input-group mb-3">
